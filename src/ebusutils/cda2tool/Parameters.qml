...
ParamRegistry {
    ...
    property ScalarMetaParam eventClearToSerial: ScalarMetaParam {
        param: ScalarParam {
            registry: root
            dataType: Param.S32
            addr: paramId.eventClearToSerial
            writable: true
            saveable: false
            slot: slots.raw32
            name: qsTr("")
    ...
    property ScalarMetaParam eventViewFreezeSize: ScalarMetaParam {
        param: ScalarParam {
            registry: root
            dataType: Param.U32
            addr: paramId.eventViewFreezeSize
            writable: false
            saveable: false
            slot: slots.raw32
            name: qsTr("")
