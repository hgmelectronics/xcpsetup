...
namespace SetupTools
{
    ...
    {
        return (result > static_cast<int>(SetupTools::OpResult::_FAILURE_BEGIN)) && (result < static_cast<int>(SetupTools::OpResult::_WARNING_BEGIN));
    }

    bool OpResultWrapper::isWarning(int result)
    {
        return (result > static_cast<int>(SetupTools::OpResult::_WARNING_BEGIN));
    }
}
