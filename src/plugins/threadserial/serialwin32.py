...
class Win32Serial(SerialBase):
    ...
    def __init__(self, *args, **kwargs):
        self.hComPort = None
        self._comCtrlLock = threading.Lock()
    ...
    def read(self, size=1):
        ...
        if size > 0:
            ...
            if not err:
                ...
                comstat = win32.COMSTAT()
                with self._comCtrlLock:
                    win32.ClearCommError(self.hComPort, ctypes.byref(flags), ctypes.byref(comstat))
    ...
    def write(self, data):
        ...
        if data:
            ...
            n = win32.DWORD()
            err = win32.WriteFile(self.hComPort, data, len(data), ctypes.byref(n), None)
