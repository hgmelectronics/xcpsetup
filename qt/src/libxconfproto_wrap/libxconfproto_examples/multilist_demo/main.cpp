...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<MultiselectListWrapper>("com.setuptools.examples.multilist_demo", 1, 0, "MultiselectListWrapper");
    qmlRegisterType<MultiselectListModel>("com.setuptools.examples.multilist_demo", 1, 0, "MultiselectListModel");
    qmlRegisterType<MultiselectListController>("com.setuptools.examples.multilist_demo", 1, 0, "MultiselectListController");
